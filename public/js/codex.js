...
// 二、丹药（含瓶颈专属丹 + 商店丹）
  ...
  { id: 'pill_yanlu', category: '丹药', name: '炎玉丹', rarity: '高阶丹药', source: '丹炉炼制（需炎玉灵枣·灵草杂交）', effect: '服用后随机提升一项道基 4~8 级；连续服用会产生丹毒。', toxicity: 16 },
  { id: 'pill_yuhua', category: '丹药', name: '玉华丹', rarity: '圣品丹药', source: '丹炉炼制（需玉华灵髓·灵草杂交）', effect: '服用后随机提升一项道基 5~10 级；连续服用会产生丹毒。', toxicity: 18 },
