...
// 2026-08-19 视觉升级：统一墨金玄境配色，线条更克制、更具国风仙气。
const BUILT_IN_AVATARS = [
  { id: 'sword', name: '剑修', svg: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><defs><linearGradient id="av1" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#e8cf86"/><stop offset="1" stop-color="#9e7b3a"/></linearGradient></defs><circle cx="32" cy="32" r="30" fill="#14171c" stroke="url(#av1)" stroke-width="1.5"/><g fill="none" stroke="url(#av1)" stroke-linecap="round" stroke-width="2.2"><path d="M32 12v36"/><path d="M26 22l6-8 6 8"/><path d="M22 42c4-6 16-6 20 0"/></g><circle cx="32" cy="48" r="2.5" fill="url(#av1)"/></svg>` },
  { id: 'dao', name: '道人', svg: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><defs><linearGradient id="av2" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#7fb69e"/><stop offset="1" stop-color="#4a7c6f"/></linearGradient></defs><circle cx="32" cy="32" r="30" fill="#14171c" stroke="url(#av2)" stroke-width="1.5"/><path d="M24 20h16l-4 8H28z" fill="none" stroke="url(#av2)" stroke-width="2" stroke-linejoin="round"/><circle cx="32" cy="36" r="7" fill="none" stroke="url(#av2)" stroke-width="2"/><path d="M22 48c0-8 20-8 20 0" fill="none" stroke="url(#av2)" stroke-width="2" stroke-linecap="round"/><path d="M32 20v-6" stroke="url(#av2)" stroke-width="2" stroke-linecap="round"/></svg>` },
  { id: 'fox', name: '狐仙', svg: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><defs><linearGradient id="av3" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#e8a87c"/><stop offset="1" stop-color="#b56b54"/></linearGradient></defs><circle cx="32" cy="32" r="30" fill="#14171c" stroke="url(#av3)" stroke-width="1.5"/><path d="M18 20l10 14-6 4zM46 20l-10 14 6 4z" fill="url(#av3)" opacity=".85"/><circle cx="26" cy="40" r="2" fill="url(#av3)"/><circle cx="38" cy="40" r="2" fill="url(#av3)"/><path d="M30 47q2 3 4 0" fill="none" stroke="url(#av3)" stroke-width="1.5" stroke-linecap="round"/><circle cx="32" cy="28" r="3" fill="url(#av3)"/></svg>` },
  { id: 'lotus', name: '莲心', svg: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><defs><linearGradient id="av4" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#d8b15a"/><stop offset="1" stop-color="#a8833d"/></linearGradient></defs><circle cx="32" cy="32" r="30" fill="#14171c" stroke="url(#av4)" stroke-width="1.5"/><g fill="none" stroke="url(#av4)" stroke-width="2" stroke-linecap="round"><path d="M32 44V28"/><path d="M32 28c-6-8-12-4-10 2s8 8 10 6c2 2 8 0 10-6s-4-10-10-2z"/></g><circle cx="32" cy="30" r="3.5" fill="url(#av4)"/></svg>` },
  { id: 'shadow', name: '魔修', svg: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><defs><linearGradient id="av5" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#c46a6a"/><stop offset="1" stop-color="#7a3535"/></linearGradient></defs><circle cx="32" cy="32" r="30" fill="#14171c" stroke="url(#av5)" stroke-width="1.5"/><path d="M20 24c4-4 20-4 24 0" fill="none" stroke="url(#av5)" stroke-width="2" stroke-linecap="round"/><circle cx="24" cy="34" r="3" fill="url(#av5)"/><circle cx="40" cy="34" r="3" fill="url(#av5)"/><path d="M28 46c2-3 6-3 8 0" fill="none" stroke="url(#av5)" stroke-width="2" stroke-linecap="round"/><path d="M16 18l6 6M42 24l6-6" stroke="url(#av5)" stroke-width="2" stroke-linecap="round"/></svg>` },
  { id: 'cloud', name: '云游', svg: `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><defs><linearGradient id="av6" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#8fbfd3"/><stop offset="1" stop-color="#5d8aa8"/></linearGradient></defs><circle cx="32" cy="32" r="30" fill="#14171c" stroke="url(#av6)" stroke-width="1.5"/><path d="M18 38c3-10 13-6 16-12 3 6 13 2 16 12-2 8-12 8-16 6-4 2-14 2-16-6z" fill="none" stroke="url(#av6)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M32 24v-8M28 20h8" stroke="url(#av6)" stroke-width="2" stroke-linecap="round"/><circle cx="24" cy="42" r="2" fill="url(#av6)" opacity=".6"/><circle cx="40" cy="42" r="2" fill="url(#av6)" opacity=".6"/></svg>` },
];
